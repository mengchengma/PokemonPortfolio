export const PROJECTS = [
  ...
  },
  {
    ...
    name: "WEBDEVMON",
    description:
      "Web development at National Urban Technology Center. Improved website traffic by 70% through SEO optimization and WordPress development with HTML/CSS.",
    emoji: "🌐",
    spritePath: "/sprites/darkrai.gif",
    types: ["WordPress", "HTML/CSS"],
    link: "https://github.com/mengchengma",
    role: "WEB DEV",
    status: "COMPLETE",
    stats: [
